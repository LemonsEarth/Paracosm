...
namespace Paracosm.Content.Biomes.Void
{
    public class VoidLow : ModBiome
    {
        ...
        public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.GetInstance<VoidLowBackgroundStyle>();

        public override bool IsBiomeActive(Player player)
        {
            return SubworldSystem.Current is VoidSubworld && player.ZoneRockLayerHeight;
        }

...
namespace Paracosm.Content.Items.Placeable.Furniture
{
    public class InfectedRevenantRelic : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.InfectedRevenantRelic>(), 0);

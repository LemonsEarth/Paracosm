...
namespace Paracosm.Content.Tiles.Furniture
{
    ...
    public class InfectedRevenantRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "Paracosm/Content/Tiles/Furniture/InfectedRevenantRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "Paracosm/Content/Tiles/Furniture/RelicPedestal";
